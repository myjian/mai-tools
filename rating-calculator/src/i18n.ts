...
const UIStringByLang = {
  en: {
    ...
    grade: "Grade",
    ratingTargetDistribution: "Levels and Difficulties of Rating Targets",
    column: ":",
    subtotal: "Subtotal",
    newChartsRatingTargets: "New Charts Rating Targets (best 15):",
    oldChartsRatingTargets: "Old Charts Rating Targets (best 25):",
