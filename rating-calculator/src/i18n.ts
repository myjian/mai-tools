...
const UIStringByLang = {
  en: {
    ...
    grade: "Grade",
    ratingTargetDistribution: "Levels and Difficulties of Rating Objects",
    column: ":",
    subtotal: "Subtotal",
    newChartsRatingTargets: "New Charts Rating Objects (best 15):",
    oldChartsRatingTargets: "Old Charts Rating Objects (best 25):",
