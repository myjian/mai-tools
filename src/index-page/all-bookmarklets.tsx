...
const convertDxToFinale: Bookmarklet = {
  ...
  howToByLang: {
    ...
    [Language.en_US]:
      'Usage: Log in to maimai NET. Open a recent song record and run the bookmarklet. New tab will open and display score in old achievement system. You can click on "Cafe MiLK" to switch to DX achievement, and click on the achievement % to see how much percentage was lost per note type.',
    [Language.ko_KR]:
...
const scoreSorter: Bookmarklet = {
  ...
  howToByLang: {
    ...
    [Language.en_US]:
      "Usage: For sorting own scores, open historical scores (by genre, level, song title, version, etc.) and run the bookmarklet. For sorting friend's scores, use Friend VS feature to list scores (by genre or level), and then run the bookmarklet.",
    [Language.ko_KR]:
...
const recentPlaySummary: Bookmarklet = {
  ...
  howToByLang: {
    ...
    [Language.en_US]: 'Usage: Open the recent game records list and run the bookmarklet.',
    [Language.ko_KR]: '사용법: 최근 플레이 목록 화면에 들어간 후 북마크를 실행하세요.',
  },
  screenshotUrl: './screenshots/recent-play-summary-20200704.png',
};

const analyzeSelfRating: Bookmarklet = {
  ...
  howToByLang: {
    ...
    [Language.en_US]: 'Usage: Run the bookmarklet on maimai NET home page or player data page.',
    [Language.ko_KR]: '사용법: maimai NET 메인 화면 혹은 player data 화면에서 북마크를 실행하세요.',
  },
  screenshotUrl: './screenshots/rating-analyzer-20200702.png',
};

const analyzeFriendRating: Bookmarklet = {
...
const scoreDownloader: Bookmarklet = {
  id: 'scoreDownloader',
  itemTitleByLang: {
  ...
  howToByLang: {
    [Language.en_US]:
      'Usage: Run the bookmarklet on maimai NET home page. After several seconds, a "Copy" button will appear on screen. Click the Copy button to copy scores. You can paste them in Excel or Google Sheets.',
...
const albumDownloadHelper: Bookmarklet = {
  ...
  howToByLang: {
    ...
    [Language.en_US]:
      'Usage: Open PHOTOS page and run this bookmarklet. Photos on the page will be clickable and have proper filenames.',
    [Language.ko_KR]:
